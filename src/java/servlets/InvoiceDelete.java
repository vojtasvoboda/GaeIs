...
public class InvoiceDelete extends HttpServlet{
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        System.out.println("InvoiceDelete: id pro smazání je " + id);
        // zjistime klic
        Key k = KeyFactory.stringToKey(id);
        // zjistime kategorii z DAO dle klice
        InvoiceDAO dao = new InvoiceDAO();
        Invoice supp = dao.get(k);
        System.out.println("InvoiceDelete: id z objektu je " + supp.getId());
        // a smazeme ho
        dao.delete(supp);

        resp.sendRedirect("/invoices?smazano=1");
    }
